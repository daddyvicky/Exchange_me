...
$pos=stripos($url,"validate");
$check=0;
if(strlen($url)<= $pos+12){
...
<head>
    ...
    <title>Exchangeme-Buy, sell or exchange anything</title>
...
<body>
        ...
        <div class="header__top">
            <div class="ps-container">
                <div class="header__left">
                    ...
                    </div><a class="ps-logo" href="index.html"><img src="img/logo.png" alt="" width="250px"></a>
                </div>
                ...
                <div class="header__right">
                    <div class="header__actions"><a class="header__extra" href="#"><i class="icon-heart"></i><span><i>0</i></span></a>
                        ...
                        <div class="ps-block--user-header">
                            ...
                            <div class="ps-block__right"><a style="cursor: pointer;" href="login.php"><?php echo getloginame()?></a>
                                <!-- <a data-toggle="modal" data-target="#register" style="cursor: pointer;" id="popRegister">Register</a> -->
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <nav class="navigation">
            <div class="ps-container">
                ...
                <div class="navigation__right">
                    <ul class="menu">
                        <li class=""><a href="index.html">Home</a></span></li>
                        <li class=""><a href="index.html">Electronic</a></span></li>
                        <li class=""><a href="index.html">Mobiles</a></span></li>
                        <li class=""><a href="index.html">Fashion</a></span></li>
                        <li class=""><a href="index.html#Bestsellers">Best Sellers</a></span></li>
                    </ul>
                    <ul class="navigation__extra">
                        <li><a href="#">Sell on Exchangeme</a></li>
                        <li><a href="#">Track your order</a></li>
                        <li>
                            <div class="ps-dropdown"><a href="#">INR</a>
    ...
    <header class="header header--mobile" data-sticky="true">
        <div class="header__top">
            <div class="header__left">
                <p>Welcome to Exchangeme Online Shopping Store !</p>
            </div>
            <div class="header__right">
                <ul class="navigation__extra">
                    <li><a href="#">Sell on Exchangeme</a></li>
        ...
        <div class="navigation--mobile">
            ...
            <div class="navigation__right">
                <div class="header__actions">
                    ...
                    <div class="ps-block--user-header" style="cursor: pointer;">
                        <div class="ps-block__left"><i class="icon-user"></i></div>
                        <div class="ps-block__right"><a style="cursor: pointer;" href="login.php"><?php echo getloginame()?></a>
                            <!-- <a data-toggle="modal" data-target="#register" style="cursor: pointer;">Register</a> -->
                        </div>
                    </div>
                </div>
            </div>
...
<div class="ps-my-account">
	<div class="container">
	<?php
	if (isset($_GET['id']) && $_GET['id'] !== '' && isset($_GET['hash']) && $_GET['hash'] !== '' && $check==0) {
	...
	?>
		<form class="ps-form--account ps-tab-root" id="validateEmailForm">
			<div class="ps-tabs">
				<div class="ps-tab active" id="sign-in">
						<div class="ps-form__content">
							...
							<div class="form-group submit">
								<div class="ps-btn ps-btn--fullwidth" onclick="sendValidateEmailRequest();">Send</div>
							</div>
							Already Verified? <a href="./login" style="color: #2874f0;">Login</a>
						</div>
    ...
    <footer class="ps-footer">
        <div class="ps-container">
            <div class="ps-footer__widgets">
                <aside class="widget widget_footer widget_contact-us">
                    ...
                    <div class="widget_content">
                        <p>Call us 24/7</p>
                        <h3>1800 97 97 69</h3>
                        <p>502 New Design Str, Melbourne, Australia <br><a href="mailto:contact@Exchangeme.co">contact@Exchangeme.co</a></p>
                        <ul class="ps-list--social">
            ...
            <div class="ps-footer__copyright">
                <p>© 2018 Exchangeme. All Rights Reserved</p>
